...
<head>
    ...
    <link rel="stylesheet" href="css/abouts_us.css">
...
<body>
    <div id="nav">
        ...
        <div id="right_nav">
            <div id="right_nav_link">
                ...
                <a class="nav_link" href="about_us.html" style="color: #399918;">About Us</a>
    ...
    <div id="wallpaper_div">
        <img src="assets/abt_cover.jpg" alt="">
        <p>About Us</p>
    </div>
    ...
    <div id="learn_more">
        ...
        <div id="learn_more_right">
            <img id="learn_more_img" src="assets/nurse_group.jpg" alt="">
        </div>
